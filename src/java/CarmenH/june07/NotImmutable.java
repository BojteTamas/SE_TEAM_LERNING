...
public class NotImmutable {
    ...
    */
    ...
    public static void main (String[] args) {
        ...
        System.out.println(ciuciulica.getBuilder()); // this outputs "initial added more" that means is not immutable, the val
        //we are passing the same StringBuilder all over
        //The caller has a reference since it was passed to the constructor. Anyone who calls the getter gets a reference too.
