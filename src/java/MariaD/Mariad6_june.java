...
public class Mariad6_june {
    public static void main(String[] args) {
        ...
        md.delete(1,3);//md=vationmode//deleted ca. starts counting from 0. deletes starting with index1 up to index3
        md.deleteCharAt(6);///md = vationode deletes only the letter from index 6. starts counting from 0
        System.out.println(md);
    }
}
