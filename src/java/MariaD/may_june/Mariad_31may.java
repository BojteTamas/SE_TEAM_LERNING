...
//!!!indexes begin with 0 (same as charAt , but it doesn't throw exception when it doesn't find a characted)
/*
    public class Mariad_31may {
    public static void main(String[] args) {
        String string = "animals";
...
public class Mariad_31may {
    public static void main(String[] args) {
       ...
       // System.out.println(string.substring(3));//output puter// take the characters starting with index 3
        //System.out.println(string.substring(string.indexOf('m')));//mputer cals indexOf() to get the index
       //System.out.println(string.substring(3,5));//pu-- starts with 3, and it stops at index 4
        System.out.println(string.substring(2,6));//mpu --take the characters starting from index 2, up until index 6
    }
}
