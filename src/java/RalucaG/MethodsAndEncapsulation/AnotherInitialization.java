...
/**Instance Initialization Blocks :  used to initialize instance variables, executed before constructors.
 * They run each time when an object of the class is created.
 *
 Initializer block : the code that is always executed whenever an instance is created.
