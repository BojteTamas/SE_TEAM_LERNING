package DragosT; // public class Dragos15Aprilie {
...
//    default section. We’ll discuss break statements in detail when we discuss loops, but for now
// all
//    you need to know is that they terminate the switch statement and return flow control to the
// enclosing
//    statement. As we’ll soon see, if you leave out the break statement, flow will continue to the
// next
