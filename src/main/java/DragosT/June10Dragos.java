...
public class June10Dragos {
  ...
  //  public void varargument3(int... nums, int start) { } // does not compile vararg must be last
  // parameter
  //   public void varargument4(int... start, int... nums) { } // does not compile vararg can be
  // only 1 per method
