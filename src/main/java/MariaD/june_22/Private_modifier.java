...
public class Private_modifier {
  public static void main(String[] args) {
    A obiect = new A();
    System.out.println(obiect.data); // /ERROR!!!java: data has private access in MariaD.june_22.A
...
public class Private_modifier {
  public static void main(String[] args) {
    A obiect = new A(); // /java: A() has private access in MariaD.june_22.A
  }
}
 */
