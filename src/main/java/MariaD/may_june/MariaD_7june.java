...
// StringBuilder is used internally for performance purposes, but the end result needs to be a
// string!!!!
/*public class MariaD_7june {
    public static void main(String[] args) {
        StringBuilder md = new StringBuilder("MATHS");
 ...
 */
// StringBuilder vs StringBuffer --they do the same thing, but StringBuffer does it more slowly
