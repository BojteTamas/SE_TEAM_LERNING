...
public class TraditionalSearch {
  public static void main(String[] args) {
    ...
    print(
        animals,
        a -> a.canSwim()); // this gets an error - added by mistake an } in Animal class - that's
    // why got error
    ...
    /**
     * Deferred execution means that code is specified now but will run later. In this case, later
     * is when the print() method calls it.
     */
  }
