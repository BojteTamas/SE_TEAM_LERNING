...
public class Animal {
  ...
  public boolean canHop() {
    return canHop;
  } // method that gets the state of canHop

  public boolean canSwim() {
    return canSwim;
  } // method that gets the state of canSwim

  public String toString() {
    return species;
  } // method so we can easily identify the Animal in programs.? how
}

    /**
     * to write different checks we need an interface remember that an interface specifies the
     * methods that our class needs to implement
     */
