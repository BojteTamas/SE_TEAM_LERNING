 ...
 *  it is not required to provide an implementation for the getName() method
 *
 *  The class Lion is not marked as abstract, and as the first concrete subclass,
 *  it must implement all inherited abstract methods not defined in a parent class.
 *
 ...
 *
 *  the subclasses do not consider it an inherited abstract method because
 *  it is no longer abstract by the time it reaches the subclasses.
 */