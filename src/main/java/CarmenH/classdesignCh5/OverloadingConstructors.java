...
public class OverloadingConstructors {
  ...
  //    }
  /**
   * Two reasons why doesn't work: 1. the method has the same number of arguments as the one above
   * "Overloaded methods may have the same or different return types, but they must differ in
   * parameters." 2. the third parameter should be string "f" not genre.
   */
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "soarecele meu are culoarea "
            + referinta_mea.color
            + " , are "
            + referinta_mea.weight
            + " grame iar genul este: "
            + referinta_mea.genre);
  }
}
/// page 291 test 5
