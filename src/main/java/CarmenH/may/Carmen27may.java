...
public class Carmen27may {
  ...
  public static void main(String[] args) {
    ...
    //  walk(1); // passes 1 as start but nothing else. This means Java creates an array of length 0
    // for nums
    //    walk(1, 2); // passes 1 as start and one more value. Java converts this one value to an
    // array of length 1
    //   walk(1, 2, 3); //passes 1 as start and two more values. Java converts these two values to
