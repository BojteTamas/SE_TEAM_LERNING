...
public class Initializers {
  ...
  private static final ArrayList<String> values =
      new ArrayList<>(); // It actually does compile. values is a reference variable.
  // We are allowed to call methods on reference variables. All the compiler can do is check that we
  // don’t try to reassign the final values to point to a different object.
}
