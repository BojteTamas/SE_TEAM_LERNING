...
public class Gorilla { // created parameter
  ...
  public static void announceBabiesToEveryone() {
    addGorilla();
    babyGorilla(); // DOES NOT COMPILE - non-static method babyGorilla cannot be referenced from a
    // static context
  }
...
// made it to compile but I don't know how total and count are modified . Also how we use announce
// methods?
