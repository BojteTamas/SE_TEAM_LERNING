...
public class Hamster {
  ...
  public Hamster(
      int weight) { // 3rd constructor - sets weight and color on the object we are trying to
    // instantiate
    this(weight, "brown");
  }
  ...
  */
  ...
  public static void main(String[] args) {
    ...
    Hamster hamsterica =
        new Hamster(
            213); // if I comment the first  constructor with the 3rd constructor, it calls the
    // second costructor with default color "brown"
  }
}
