...
public class Swan {
  ...
  public void setNumberEggs(int numberEggs) { // setter = mutator method
    ...
    // we used the this keyword that we saw in constructors to differentiate between the method
    // parameter numberEggs and
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        lebaduta
            .getNumberEggs()); // first I printed the reference, only lebaduta - after that used the
    // reference to call the getter
