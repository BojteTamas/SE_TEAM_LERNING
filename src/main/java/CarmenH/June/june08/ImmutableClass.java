...
public final class ImmutableClass {
  ...
  /**
   * Date class is mutable so we need a little care here. We should not return the reference of
   * original instance variable. Instead a new Date object, with content copied to it, should be
   * returned.
   */
