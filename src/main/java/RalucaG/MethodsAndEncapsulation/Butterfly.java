...
// combo: constructor with one int parameter and one string-- let's try constructor with three
// strings
public class Butterfly {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "The following butterfly is from the species "
            + b.species
            + "  that is part of the family of  "
            + b.order
            + "  and it has the most colorful and eye-catching nuance of "
            + b.coloring);
  }
}
