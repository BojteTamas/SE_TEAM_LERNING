...
/**
 * to remember: Encapsulation refers to preventing callers from changing the instance variables
...
public class NotImmutable {
  ...
  public static void main(String[] args) {
    NotImmutable obj =
        new NotImmutable(
            "This is a mutable class :you can modify the values and has getters and setters of the objects");
