...
public class JavaApi {
  public static void main(String[] args) throws Exception {
    ...
    */
    ...
    /**
     * replace() - does a simple search and replace on the string there is a version that takes char
     * parameters and one that takes CharSequence parameters String replace (char oldChar, char
     * newChar) String replace (CharSequence, oldChar, CharSequence newChar)
     */
    System.out.println("abcabc".replace("a", "A")); // AbcAbc
    System.out.println("abcabc".replace('a', 'A')); // AbcAbc

    /** trim() removes whitespace from the beginning and end of a String public String trim() */
    ...
    /** StringBuilder we = new StringBuilder("abcdef"); we.delete(1,3); we.deleteCharAt(5); */
     ...
     * an array is a n ordered list int[] numbers1 = new int[3]; int[] numbers2 = {42,55,99}; int[]
     * numAnimals; int[] numAnimals2; int numAnimals3[]; int numAnimals4[];
     */
    ...
    String[][] rectangle =
        new String[3]
            [2]; // result is an array rectangle with three elements each of which refers to an
    ...
    // Autoboxing - you can just type the primitive value and Java will convert it to the relevant
    // wrapper class
